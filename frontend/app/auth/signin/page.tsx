    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Welcome back to WebhookDB</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-500 mt-4">
          No account?{' '}
          <a href="/auth/signup" className="text-violet-600 hover:underline font-medium">Create one</a>
        </p>
      </div>
      </div>
    </div>
